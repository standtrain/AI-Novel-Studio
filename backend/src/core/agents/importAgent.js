...
- chapterCount 字段要求：必须是 100~200 之间的整数，这是网文的标准篇幅。禁止返回 1 或任何小于 100 的值`;
    ...
    const chapterCountDesc = noChapterMarkers || isPartialImport
      ? `全书总章节数（整数）。这是网络小说，标准篇幅为 100~200 章，你必须返回 100~200 之间的整数，禁止返回 1 或任何小于 100 的数值`
      : chapters.length;
